...
assert.deepEqual(consumeExtraLife(), { remaining: 1, capacity: 2 })
assert.deepEqual(refillExtraLifeCharge(), { remaining: 2, capacity: 2 })
assert.deepEqual(refillExtraLifeCharge(), { remaining: 2, capacity: 2 })
...
assert.deepEqual(refillExtraLifeCharge(), { remaining: 0, capacity: 0 })
