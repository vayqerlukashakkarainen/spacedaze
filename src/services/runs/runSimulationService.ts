...
import { ABILITIES, getAbilityDefinition } from "../abilities/abilityRegistry"
...
import { REWARD_RARITY_ORDER } from "../economy/rewardQualityService"
import {
	createSimulatedEncounterEnemies,
	selectEncounterDefinition,
} from "../enemies/enemyEncounterCatalogService"
import {
	isEnemyProgressionUnlocked,
	type ProgressionEnemyId,
} from "../enemies/enemyProgressionService"
import {
	BASE_PLAYER_HEALTH,
	HULL_UPGRADE_AMOUNT,
	LEGACY_PLAYER_DAMAGE_SCALE,
} from "../player/playerHealthBalance"
